package com.longtran.happyplaces.database
...
class DatabaseHandler(context: Context) :
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
        ...
        // Inserting Row
        val upDate = db.update(TABLE_HAPPY_PLACE, contentValues, KEY_ID + "=" + happyPlace.id,null)
        //2nd argument is String containing nullColumnHack
    ...
    //NOTE retrieve entry from database
